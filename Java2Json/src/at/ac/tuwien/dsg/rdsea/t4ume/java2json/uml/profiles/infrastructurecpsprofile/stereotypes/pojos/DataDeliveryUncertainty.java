...
/************************************
This POJO Java class is automatically generated from the DataDeliveryUncertainty stereotype
...
public class DataDeliveryUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("DataDeliveryUncertainty");

	public DataDeliveryUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the DataDeliveryUncertainty POJO class
		
		DataDeliveryUncertainty _stereo = new DataDeliveryUncertainty();
		_stereo.toJson();
