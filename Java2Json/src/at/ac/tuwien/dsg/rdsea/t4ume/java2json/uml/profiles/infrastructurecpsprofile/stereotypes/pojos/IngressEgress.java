...
/************************************
This POJO Java class is automatically generated from the IngressEgress stereotype
...
public class IngressEgress {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("IngressEgress");

	public IngressEgress() {
		/*
		Variable for the attribute configuration.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the IngressEgress POJO class
		
		IngressEgress _stereo = new IngressEgress();
		_stereo.toJson();
