...
/************************************
This POJO Java class is automatically generated from the ComputingConfiguration stereotype
...
public class ComputingConfiguration {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("ComputingConfiguration");

	public ComputingConfiguration() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the ComputingConfiguration POJO class
		
		ComputingConfiguration _stereo = new ComputingConfiguration();
		_stereo.toJson();
