...
/************************************
This POJO Java class is automatically generated from the MeasurementConstraint stereotype
...
public class MeasurementConstraint {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("MeasurementConstraint");

	public MeasurementConstraint() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the MeasurementConstraint POJO class
		
		MeasurementConstraint _stereo = new MeasurementConstraint();
		_stereo.toJson();
