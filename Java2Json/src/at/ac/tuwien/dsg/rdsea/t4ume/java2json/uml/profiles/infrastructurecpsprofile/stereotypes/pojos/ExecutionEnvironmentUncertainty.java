...
/************************************
This POJO Java class is automatically generated from the ExecutionEnvironmentUncertainty stereotype
...
public class ExecutionEnvironmentUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("ExecutionEnvironmentUncertainty");

	public ExecutionEnvironmentUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the ExecutionEnvironmentUncertainty POJO class
		
		ExecutionEnvironmentUncertainty _stereo = new ExecutionEnvironmentUncertainty();
		_stereo.toJson();
