...
/************************************
This POJO Java class is automatically generated from the EffectMeasurement stereotype
...
public class EffectMeasurement {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("EffectMeasurement");

	public EffectMeasurement() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the EffectMeasurement POJO class
		
		EffectMeasurement _stereo = new EffectMeasurement();
		_stereo.toJson();
