...
/************************************
This POJO Java class is automatically generated from the ElasticityUncertainty stereotype
...
public class ElasticityUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("ElasticityUncertainty");

	public ElasticityUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the ElasticityUncertainty POJO class
		
		ElasticityUncertainty _stereo = new ElasticityUncertainty();
		_stereo.toJson();
