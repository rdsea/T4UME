...
/************************************
This POJO Java class is automatically generated from the MeasurementStereotype stereotype
...
public class MeasurementStereotype {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("MeasurementStereotype");

	public MeasurementStereotype() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the MeasurementStereotype POJO class
		
		MeasurementStereotype _stereo = new MeasurementStereotype();
		_stereo.toJson();
