...
/************************************
This POJO Java class is automatically generated from the SporadicManifestation stereotype
...
public class SporadicManifestation {
	...
	*/
	...
	/*
	Variable for the attribute timesEncountered.
	*/
	@SerializedName("timesEncountered")
	private List<String> _timesEncountered = new ArrayList<String>();
	
	/*
	Variable _type with the name of the stereotype
	*/
	@SerializedName("type")
	public String __type = new String ("SporadicManifestation");

	public SporadicManifestation() {
		/*
		Variable for the attribute configuration.
		*/
		...
		*/
		...
		Variable for the attribute timesEncountered.
		*/
		this._timesEncountered = new ArrayList<String>();
	}


	public static void main(String[] args) {
		// Auto-generated method to test the SporadicManifestation POJO class
		
		SporadicManifestation _stereo = new SporadicManifestation();
		_stereo.toJson();
	 ...
	 */
	public List<String> getTimesEncountered() {
		return this._timesEncountered;
	}
	/**
	 * @param timesEncountered the timesEncountered to add
	 */
	public void addTimesEncountered(String _timesEncountered) {
		this._timesEncountered.add(_timesEncountered.toString());
	}
	/**
