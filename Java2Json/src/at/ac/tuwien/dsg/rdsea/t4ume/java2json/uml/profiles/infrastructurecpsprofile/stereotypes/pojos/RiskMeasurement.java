...
/************************************
This POJO Java class is automatically generated from the RiskMeasurement stereotype
...
public class RiskMeasurement {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("RiskMeasurement");

	public RiskMeasurement() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the RiskMeasurement POJO class
		
		RiskMeasurement _stereo = new RiskMeasurement();
		_stereo.toJson();
