...
/************************************
This POJO Java class is automatically generated from the ActuationUncertainty stereotype
...
public class ActuationUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("ActuationUncertainty");

	public ActuationUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the ActuationUncertainty POJO class
		
		ActuationUncertainty _stereo = new ActuationUncertainty();
		_stereo.toJson();
