...
/************************************
This POJO Java class is automatically generated from the UncertaintyMeasure stereotype
...
public class UncertaintyMeasure {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("UncertaintyMeasure");

	public UncertaintyMeasure() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the UncertaintyMeasure POJO class
		
		UncertaintyMeasure _stereo = new UncertaintyMeasure();
		_stereo.toJson();
