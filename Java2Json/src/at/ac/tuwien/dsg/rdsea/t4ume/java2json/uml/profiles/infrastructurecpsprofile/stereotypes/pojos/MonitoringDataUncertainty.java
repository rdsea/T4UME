...
/************************************
This POJO Java class is automatically generated from the MonitoringDataUncertainty stereotype
...
public class MonitoringDataUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("MonitoringDataUncertainty");

	public MonitoringDataUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the MonitoringDataUncertainty POJO class
		
		MonitoringDataUncertainty _stereo = new MonitoringDataUncertainty();
		_stereo.toJson();
