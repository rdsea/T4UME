...
/************************************
This POJO Java class is automatically generated from the EffectMeasure stereotype
...
public class EffectMeasure {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("EffectMeasure");

	public EffectMeasure() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the EffectMeasure POJO class
		
		EffectMeasure _stereo = new EffectMeasure();
		_stereo.toJson();
