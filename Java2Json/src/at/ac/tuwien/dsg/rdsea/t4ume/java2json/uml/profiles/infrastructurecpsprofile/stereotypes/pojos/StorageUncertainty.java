...
/************************************
This POJO Java class is automatically generated from the StorageUncertainty stereotype
...
public class StorageUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("StorageUncertainty");

	public StorageUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the StorageUncertainty POJO class
		
		StorageUncertainty _stereo = new StorageUncertainty();
		_stereo.toJson();
