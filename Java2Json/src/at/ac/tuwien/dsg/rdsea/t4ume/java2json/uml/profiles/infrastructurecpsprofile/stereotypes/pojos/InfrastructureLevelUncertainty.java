...
/************************************
This POJO Java class is automatically generated from the InfrastructureLevelUncertainty stereotype
...
public class InfrastructureLevelUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("InfrastructureLevelUncertainty");

	public InfrastructureLevelUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the InfrastructureLevelUncertainty POJO class
		
		InfrastructureLevelUncertainty _stereo = new InfrastructureLevelUncertainty();
		_stereo.toJson();
