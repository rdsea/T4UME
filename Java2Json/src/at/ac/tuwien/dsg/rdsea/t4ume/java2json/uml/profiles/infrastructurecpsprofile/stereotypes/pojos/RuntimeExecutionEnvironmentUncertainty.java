...
/************************************
This POJO Java class is automatically generated from the RuntimeExecutionEnvironmentUncertainty stereotype
...
public class RuntimeExecutionEnvironmentUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("RuntimeExecutionEnvironmentUncertainty");

	public RuntimeExecutionEnvironmentUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the RuntimeExecutionEnvironmentUncertainty POJO class
		
		RuntimeExecutionEnvironmentUncertainty _stereo = new RuntimeExecutionEnvironmentUncertainty();
		_stereo.toJson();
