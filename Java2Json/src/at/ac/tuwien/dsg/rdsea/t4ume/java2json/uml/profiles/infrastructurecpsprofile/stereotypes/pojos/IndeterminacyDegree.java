...
/************************************
This POJO Java class is automatically generated from the IndeterminacyDegree stereotype
...
public class IndeterminacyDegree {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("IndeterminacyDegree");

	public IndeterminacyDegree() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the IndeterminacyDegree POJO class
		
		IndeterminacyDegree _stereo = new IndeterminacyDegree();
		_stereo.toJson();
