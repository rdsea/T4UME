...
/************************************
This POJO Java class is automatically generated from the GovernanceUncertainty stereotype
...
public class GovernanceUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("GovernanceUncertainty");

	public GovernanceUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the GovernanceUncertainty POJO class
		
		GovernanceUncertainty _stereo = new GovernanceUncertainty();
		_stereo.toJson();
