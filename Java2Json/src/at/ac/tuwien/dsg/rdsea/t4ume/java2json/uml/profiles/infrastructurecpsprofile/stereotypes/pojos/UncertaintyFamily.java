...
/************************************
This POJO Java class is automatically generated from the UncertaintyFamily stereotype
...
public class UncertaintyFamily {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("UncertaintyFamily");

	public UncertaintyFamily() {
	}


	public static void main(String[] args) {
		// Auto-generated method to test the UncertaintyFamily POJO class
		
		UncertaintyFamily _stereo = new UncertaintyFamily();
		_stereo.toJson();
