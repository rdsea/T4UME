...
/************************************
This POJO Java class is automatically generated from the BeliefDegreeMeasure stereotype
...
public class BeliefDegreeMeasure {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("BeliefDegreeMeasure");

	public BeliefDegreeMeasure() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the BeliefDegreeMeasure POJO class
		
		BeliefDegreeMeasure _stereo = new BeliefDegreeMeasure();
		_stereo.toJson();
