...
/************************************
This POJO Java class is automatically generated from the StorageDependabilityUncertainty stereotype
...
public class StorageDependabilityUncertainty {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("StorageDependabilityUncertainty");

	public StorageDependabilityUncertainty() {
		/*
		Variable for the attribute cause.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the StorageDependabilityUncertainty POJO class
		
		StorageDependabilityUncertainty _stereo = new StorageDependabilityUncertainty();
		_stereo.toJson();
