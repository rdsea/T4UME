...
/************************************
This POJO Java class is automatically generated from the UncertaintyMeasurement stereotype
...
public class UncertaintyMeasurement {
	...
	*/
	@SerializedName("type")
	public String __type = new String ("UncertaintyMeasurement");

	public UncertaintyMeasurement() {
		/*
		Variable for the attribute description.
		*/
	...
	public static void main(String[] args) {
		// Auto-generated method to test the UncertaintyMeasurement POJO class
		
		UncertaintyMeasurement _stereo = new UncertaintyMeasurement();
		_stereo.toJson();
